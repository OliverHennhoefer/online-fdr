...
N = 100
generator = DataGenerator(n=N, contamination=0.1, dgp=GaussianProcess())
alpha_spending = AlphaSpending(alpha=0.05, spend_func=Bonferroni(1_000))
...
for i in range(0, N):
    ...
    result = alpha_spending.test_one(p_value)  # 'naive test
